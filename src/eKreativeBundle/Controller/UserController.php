...
class UserController extends Controller
{
    ...
    public function formAction()
    {
        ...
        return new JsonResponse(
            ['form' => $this->renderView('eKreativeBundle:User:new.html.twig', array('form' => $form->createView()))], 200
        );
    }
    ...
    public function saveAction(Request $request)
    {
        ...
        {
            return new JsonResponse(
                ['form' => $this->renderView('eKreativeBundle:User:new.html.twig', array('form' => $form->createView()))], 404
            );
        }
    }
